...
import NFTHistory from "../components/TopazHistory";
    ...
    return (
      <div className="m-4 flex flex-row justify-between gap-8 p-2">
        ...
        <div className="flex flex-col">
          <p className="text-sm text-teal-100">Provider</p>
          <p className="text-lg font-bold text-stone-100">{adapter.name}</p>
        </div>
        {adapter.readyState === "Installed" ? (
          adapter.connected ? (
            <button
              ...
              className="flex items-center justify-center rounded-md bg-teal-200 p-2 pl-2 pr-2 transition-all hover:bg-teal-500 hover:text-stone-100"
            >
              Disconnect
            </button>
          ) : (
          ...
          <button className="flex items-center justify-center rounded-md bg-teal-200 p-2 pl-2 pr-2 transition-all hover:bg-teal-500 hover:text-stone-100">
            Not Installed
          </button>
        )}
      </div>
  ...
  const activeTool = (_active: string) => {
    switch (_active) {
      ...
      default: {
        return (
          <div>
            <p className="text-center text-xl font-bold text-stone-100">
              Select a tool.
            </p>
          </div>
        );
    ...
    <>
      ...
      >
        <main className="flex min-h-screen w-screen grid-cols-2 flex-row gap-4 bg-stone-800">
          ...
          >
            <div className="min-w-[500px] rounded-md bg-stone-900 p-4">
              <p className="my-4 text-center text-xl font-bold text-teal-200">
                Select Wallet
              </p>
              ...
              <button
                ...
                className="m-auto my-4 flex items-center justify-center rounded-md bg-teal-200 p-2 pl-8 pr-8 transition-all hover:bg-teal-500 hover:text-white"
              >
                Disconnect
              </button>
              <button
                className="m-auto flex items-center justify-center rounded-md bg-teal-200 p-2 pl-8 pr-8 transition-all hover:bg-teal-500 hover:text-white"
